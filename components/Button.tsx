...
function Button() {
  return (
    <div style={{cursor:'pointer'}} className="flex items-center justify-center mb-2 cursor-pointer" id={b.buttonContainer}  >
      <Link href="/contact">
...
<span   id={b.buttonText}  className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl cursor-pointer ">
  Connect
</span>
</button>   
      </Link>
